...
export default function TournamentManagePortal() {
    const { id } = useParams();
    ...
    const {
        ...
        getTeamName
    } = useTournamentManage(id, navigate, showToast);
    ...
    useEffect(() => {
        if (tournament && (tournament.matchType === 'scrims' || (tournament as any).isScrim)) {
            navigate(`/scrims/${tournament.id}`, { replace: true });
        }
    }, [tournament, navigate]);
                ...
                <div className="flex items-center gap-3 sm:gap-6">
                    ...
                    <div className="min-w-0 flex-1">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-black uppercase tracking-tighter text-white flex items-center gap-2 sm:gap-4">
                            ...
                            <span className="truncate">Tournament Management Console</span>
                        </h1>
